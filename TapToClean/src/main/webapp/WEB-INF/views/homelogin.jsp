                            ...
                            <div class="navbar navbar-expand-lg bg-light navbar-light">
                                ...
                                <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                                    ...
                                    %>
                                     ...
                                     <%= customer.getCustomerFirstname()%></a>
    ...
    <div class="img-slider">
      <div class="slide active">
        ...
        <div class="info">
          ...
          <p>Our cleaning crews are professionally trained, and if you are ever unhappy with any area we have cleaned, we will return the next day and reclean it.</p>
...
TapToClean cleaning professionals make sure to deep clean your home thoroughly that provides lasting effects for 2-3 months.
<br>	 
<b> Insurance Against Damage:</b> With TapToClean you get insurance coverage up to Rs. 10,000
on every booking against any damage.
<br>
<b> Usage of Professional grade chemicals:</b> Considering the hygiene of your house, 
we at TapToClean only use Professional grade non-hozordous chemicals for home deep cleaning.
<br>
<b> Flexibility:</b> TapToClean provides you a comprehensive professional home cleaning service
                        ...
                        <div class="col-md-7">
                            <div class="row align-items-center feature-item">
                                ...
                                <div class="col-7">
                                    ...
                                    <p>
                                        All TapToClean professionals are trained and taken through levels of background verification before getting on board to ensure the quality of work.
                                    </p>
                                </div>
                            </div>
                            <div class="row align-items-center feature-item">
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        <a class="card-link" data-toggle="collapse" href="#collapseTwo">
                                            <span>2</span> What is the TapToClean’s promise?
                                        </a>
                                    </div>
                                    <div id="collapseTwo" class="collapse" data-parent="#accordion">
                                        <div class="card-body">
                                            TapToClean's promise with home deep cleaning service (and every other
...
If you book the home deep cleaning service from TapToClean, here is
                        ...
                        <div class="testimonial-item">
                            ...
                            <div class="testimonial-content">
                                <p>
                                    ...
                                    In an attempt to keep up with modern times, I was urged to give TapToClean a chance by a friend and
                            ...
                            <div class="testimonial-content">
                                <p>
                                    With the strenuous and demanding job that I have, I don't get much time to look after household chores
                                     and cleaning routines and yet as a woman I don't like anything less than perfect, TapToClean takes care of all 
                            ...
                            <div class="testimonial-content">
                                <p>
                                    ...
                                    every aspect of my life. Hygiene and cleanliness can be provided by anyone but I happen to be picky and want
                                     everything according to my liking, TapToClean makes it easy by delivering everything specific to my instructions 
